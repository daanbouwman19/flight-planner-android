...
**The globe is an outline globe, not a photograph — see "The globe is a step
taken on purpose" above** for what it draws and does not. It is a faithful
geometric port (`geo/globeFrame.ts`), not decoration; only the imagery itself
is a divergence.
